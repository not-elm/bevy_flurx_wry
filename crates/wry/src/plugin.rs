...
use bevy::prelude::{Commands, Deref, DerefMut, Entity, In, NonSend, NonSendMut, Query, Res, With};
use bevy::utils::HashMap;
use bevy::window::Window;
use bevy::winit::WinitWindows;
use bevy_flurx::action::once;
use bevy_flurx::prelude::Reactor;
use wry::{http, WebView, WebViewBuilderExtWindows};
use wry::http::header::CONTENT_TYPE;
use wry::http::Response;

use bevy_flurx_ipc::ipc_command_queue::{IpcCommand, IpcCommandQueue};

use crate::bundle::{Background, Theme, Uri, UseDevtools};
use crate::plugin::ipc::WryIpcPlugin;
use crate::plugin::on_page_load::{OnPageArgs, OnPageLoadPlugin, PageLoadEventQueue};
use crate::prelude::{AutoPlay, EnableClipboard, Visible, WebviewUninitialized};
...
pub(crate) struct WebviewMap(HashMap<Entity, wry::WebView>);
    ...
    for (
        ...
        let builder = {
            ...
            wry::WebViewBuilder::new(window)
                .with_initialization_script(include_str!("./plugin/initialize.js"))
