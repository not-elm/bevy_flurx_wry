...
use crate::core::plugin::handlers::document_title_changed::{DocumentTitleChanged, DocumentTitlePlugin};
use crate::core::plugin::handlers::download::{DownloadCompleted, DownloadPlugin, DownloadStarted};
use crate::core::plugin::handlers::drag_drop::{DragDropPlugin, WryDragDrop};
use crate::core::plugin::handlers::navigation::{NavigationPlugin, NavigationStarted};
use crate::core::plugin::handlers::new_window_request::{NewWindowRequested, NewWindowRequestedPlugin};
use crate::core::plugin::handlers::page_load::{PageLoadFinished, PageLoadPlugin, PageLoadStarted};
...
pub mod prelude {
    pub use crate::core::plugin::handlers::{
